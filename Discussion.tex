...
Early soil microbial ecology was informed by studying pure cultures. 
As reviewed by \citet{} historically important pure cultures from soil 
...
\textit{Streptomyces} (Alexander citation) but
culture-independent
surveys of soil microbial diversity revealed
soil may harbor as many as 5,000 OTUs per half gram soil (CITE schloss census). Although
standard culturing techniques are able to produce isolates from diverse soil
lineages (CITE jannsen), numerically dominant soil microorganisms are still uncultured
and we know little of their ecophysiology (CITE jannsen). Microbiologists
often lament the simplistic single term inclusion of microbial biomass in soil
nutrient flux models (CITE manzoni?), but we need to characterize the functional roles of
