...
relatively heavy buoyant densities (Figure~\ref{fig:ord}). Also, $^{13}$C-DNA
from $^{13}$C-xylose microcosms is different in phylogenetic composition from
...
It is difficult to interpret results from DNA-SIP experiments wherein only heavy
