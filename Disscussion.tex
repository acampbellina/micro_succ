...
\textit{Verrucomicrobia} are ubiquitous in soil worldwide \citep{Bergmann_2011}. \textit{Verrucomicrobia} 
can constitude 23\% of 16S rRNA gene sequences in high-throughput DNA sequencing surveys of 
SSU rRNA genes in soil \citep{Bergmann_2011} and
have been shown to represent XX\% of soil rRNA CITE. Many \textit{Verrucomicrobia} cultivars
...
importatance of soil \textit{Verrucomicrobia} in C-cycling is largely unknown. For example, 
...
share at lease 97\% sequence identity with isolates. HR-SIP identifies key players in soil C
-cycling that represent important targets for single cell and community genomics studies CITE
CITE. \textit{Verrucomicrobia} lineages, given there ubiquity and abundance in soil, may play 
