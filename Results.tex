\section{Results}
% Fakesubsubsection:To observe C use dynamics by the soil microbial
...
0.42 mg xylose-C and 0.88 mg cellulose-C g soil$^{-1}$.  Microcosms were harvested at days 1, 3, 7, 14 and 30  during a 30 day incubation. $^{13}$C-xylose assimilation peaked immediately and tapered over the 30 day incubation whereas $^{13}$C-cellulose assimilation peaked at two weeks of (Figure~\ref{fig:ord}).

% Fakesubsubsection:We sequenced SSU rRNA gene amplicons from a
...
% Fakesubsubsection:At day 1, 84\% of $^{13}$C-xylose responsive OTUs
