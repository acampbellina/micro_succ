...
\textit{Agromyces} OTU is assimilating $^{13}$C by predataion on $^{13}$C
labeled microorganisms if \textit{Agromyces} is selective enough with respect to its prey such that it primarily attacked $^{13}$C-xylose assimilating organisms.
...
show less substrate specificity for cellulose than some xylose utilizers for xylose (Figure~XX).
Further, each responder group exhibits a range of substrate specificites (Figure~XX).
