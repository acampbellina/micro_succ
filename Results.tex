...
and similarities between gradients. Its clear that microcosms incorporated
...
density and soil type on the variance between gradient phylogenetic profiles.
...
fractions from both control and labeled gradients, we can observe incorporation
begins in addition to which buoyant densities along the CsCl gradients iss
isotope incorporation signal strongest (Figure~\ref{fig:ord}). $^{13}$C
