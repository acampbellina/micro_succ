\section{Results}
In this study, we couple nucleic acid SIP with high-throughput DNA sequencing
to observe C use dynamics by the soil microbial community. A series
of parallel soil microcosms all amended with a C substrate mixture were
incubated for 30 days. The substrate mixture was identical for each microcosm
except in one series of microcosms the cellulose was $^{13}$C-labeled in another
...
biomass. Amendment codes in figures are as follows: "13CXPS" refers to the
amendment with $^{13}$C-xylose (that is "$^{13}$C \textbf{x}lose \textbf{p}lant 
\textbf{s}imulant), "13CCPS" refers to the $^{13}$C-cellulose amendment and 
"12CCPS" refers to the amendment that only received $^{12}$C substrates. To examine C
assimilation dynamics for labile, soluble C versus insoluble, polymeric C xylose 
or cellulose were chosen to carrt the isotopic label.  5.3
...
genome and and day of first response are correlated (p-value 2.02e$^{-15}$,
...
Table~\ref{tab:xyl}) has a mean abundance in bulk relative abundance in samples
...
responders sorted by descending mean rank (essentially the 10 most abundandant
...
0.23, R$^{2}$ 0.63, Figure~XX) but treatment (\textit{i.e.} the contrast
