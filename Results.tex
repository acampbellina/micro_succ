...
responders}
$^{13}$C-xylose responders are generally more abundant members based on relative abundance in bulk DNA SSU rRNA gene content thanthan $^{13}$C-cellulose responders (Figure~XX, p-value).
However, both $^{13}$C-xylose and $^{13}$C-cellulose responders were found in abundant and 
rare OTUs (Figure~XX). For instance,
