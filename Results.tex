...
after amendment additions(Figure~\ref{fig:ord}, Figure~\ref{fig:rspndr_count}). See
...
\citep{Anderson2006,oksanen2007vegan}, Figure~\ref{fig:bulk_ord}).
...
labeled substrate responders (Figure~\ref{fig:time}). If sequences were grouped
by taxonomic annotations at the class level, only four classes significantly
...
xylose responders in response to isotope incorporation
(Figure~\ref{fig:c1}, Figure~\ref{fig:shift}, p-value 1.8610x$^{-06}$).
