...
abundant in the bulk samples ("OTU.5", Table~XX) with a mean bulk rank of 13 (\textit{i.e.} 
on average the 13th most abundant OTU) and a $^{13}$C-xylose responder ("OTU.1040, Table~XX) has
a mean abundance in bulk relative abundance in samples of 2.85e$^{-05}$. Only one substrate
responder ($^{13}$C-cellulose) was not found in any bulk samples ("OTU.862", Table~XX). Of the top 10 responders sorted by descending mean rank (essentially the 10 most abundandant responders
