...
has not been used to demonstrate isotope incorporation in DNA which requires careful
...
observe when--as in at want time point during incubation--as well as \text{where}--as in
at what buoyant densities along the CsCl gradients--does isotope incorporation signal 
becomes apparent (Figure~\ref{fig:ord}). Specifically, 13... 
