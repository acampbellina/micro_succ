...
\textit{Firmicutes} to \textit{Bacteroidetes} and then \textit{Actinobacteria}
across days 1, 3 and 7 (Figure~\ref{fig:l2fc}). At any given time soils harbor
...
could stimulate dormant microbes. 
