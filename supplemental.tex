...
the amendment. The treatments includeThe treatments includedl treatment and
...
OTUs concentration across the gradient mirrored that of the total DNA. If OTU
DNA is positioned in heavy or light fractions, however, due to G$+$C content
and/or $^{13}$C-labeling, it increases in relative abundance in the density region
where the OTU absolute abundance is centered. Thus, we identified responders by finding OTUs
enriched in heavy fractions of $^{13}$C-treatment gradients relative to
